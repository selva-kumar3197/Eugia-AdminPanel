...
function TreatmentList() {
    ...
    const productsListApi = () => {
        axios({
            mathod: "GET",
            url: `${baseURL}/category/treatment`,
        }).then((res) => {
            if (res.status == 200) {
    ...
    const handleSubmit = () => {
        ...
        axios({
            ...
            if (res.status == 200) {
                setReloadPage(reloadPage + 1)
                setShow(false)
                toast.success('Successfully Updated Treatment')
                setLoader(false)
                setupdateMemberForm({
                    ...updateMemberForm,
                    name: '',
    ...
    const handleData = (value) => {
        ...
        setupdateMemberForm({
            ...updateMemberForm, ['text']: value
        })
        setupdateMemberFormErrors({
            ...updateMemberFormErrors, ['text']: null
        })
    }
    ...
    const [colDefs, setColDefs] = useState([
        ...
        {
            headerName: "Treatment Heading",
            filter: true,
            field: "title",
        },
        // {
        //     headerName: "Treatment Text",
        //     filter: true,
        //     field: "description",
        // },
        {
            ...
            cellRendererFramework: (params) => (
                <center>
                    <p>{JSON.stringify(htmlToDraft(params?.data?.description).contentBlocks[0].text)}</p>
                </center>
            ),
        },
        {
            headerName: "Treatment Image",
            filter: false,
            cellRendererFramework: (params) => (
                <center>
                ...
                <Modal.Body>
                    <div className="col-md-12">
                        ...
                        <Row>
                            ...
                            <MyStatefulEditor handleData={handleData} updateMemberForm={updateMemberForm} />
                        </Row>
                        <Row className="mt-3" >
                    ...
                    <div className="container ">
                        ...
                        <div className="row my-3">
                            <div className="col-md-4">
                                <h3>
                                    <b>All  Key Therapeutic Areas List </b>
                                </h3>
                            </div>

                            <div className="col-md-6 text-end">
                                <button type="button" className="btn btn-outline-success mx-1">
                                    <Link to="/treatment-add">Add Therapeutic Areas  </Link>
                                </button>
                                <button
                                    type="button"
                                    ...
                                    disabled
                                >
                                    <Link to="/treatment-list"> Therapeutic Areas List</Link>
                                </button>
                                <button type="button" className="btn btn-outline-success mx-1">
                        ...
                        {/* <table className="table table-bordered w-100 my-2 text-center">
                            <thead>
                                <tr className="col-12" >
                                    ...
                                    <th className="col-3">Treatment Heading</th>
                                    <th className="col-1" >Treatment Text</th>
                                    <th className="col-1" >Treatment Image</th>
